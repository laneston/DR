...
if __name__ == "__main__":
    ...
    # for tensor_object in digit_tensors[:digital_nums]:
        ...
        plt.text(0.5, -0.15, f"estimate: {prediction}", ha='center', va='top', 
            transform=plt.gca().transAxes, fontsize=7)  # 底部预测结果[7](@ref)
        plt.axis('off')
